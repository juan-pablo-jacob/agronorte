        ...
        <form action="{{url("/cliente/" . $cliente->id)}}" method="post" enctype="multipart/form-data">
            ...
            <div class="content-box">
                ...
                <div class="content-box-wrapper">
                    ...
                    <div class="form-group col-md-4">
                        <label>CUIT *</label>
                        <input type="text" class="form-control" id="CUIT" name="CUIT" value="{{$cliente->CUIT}}">
                    </div>
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <select id="condicion_iva" name="condicion_iva" class="form-control">
                            ...
                            @foreach($condiciones_iva as $condicion)
                                @if($condicion->condicion_iva == $cliente->condicion_iva)
